...
function minRequirementCheck( release ){
    ...
    global.log.general('If you release is a module object, ensure there is at least a name and module string.');
    global.die();
}
...
var self = function ( commands, type, cb, count ){
    ...
    if( commands.length > 0 ){
        ...
        if( type != 'complete' ) global.log.success( 'All release commands run.' );
        global.log.general( '' );
        cb();
    }
};
