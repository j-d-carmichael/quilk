...
/**
 * Custom exception quilk json error
 * @param message
 */
function quilkJsonException(message) {
    this.message = message;
    this.name = "quilkJsonException";
}
...
function reloadQuilkJson( cb ){
    try{
        ...
        if( !cliArgs.init ) {
            console.log( clc.bold.red('quilk.json not found or could not be read') );
            throw new quilkJsonException('quilk.json not found or could not be read');
        }
    }
    if( cb ){
        cb();
            ...
            if(!haltBuild){
                ...
                try {
                    ...
                    try{
                        ...
                        console.log( clc.bold.red( 'ERROR: Could not find module "'+ global.current_module.module +'"' ) );
                        console.log( e1 );
                        console.log( e2 );
                        console.log('');
                        console.log('');
                ...
                try{
                    ...
                    console.log( clc.red.bold('There was an error in the module: ' + file ) );
                    console.log( e );
