...
if( !cliArgs.developer && !cliArgs.release ){
    console.log('ERROR: Please pass a developer to the quilk tool.');
    return false;
}
...
try{
    ...
    return console.log( 'quilk.json not found or could not be read' );
}
...
if( !quilkConf.developers[cliArgs.developer] && !cliArgs.release ){
    ...
    console.log('(If you did not pass a developer in the cli arguments then you must create a developer titled default. Please see the lib/resource/quilk.json on quilk github)');
    return false
}
